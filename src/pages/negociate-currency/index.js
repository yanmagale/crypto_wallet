...
const NegociateCurrencyPage = () => {
  ...
  async function createTransaction(transaction) {
    ...
    const balance = {
      type: 'add',
      amount: parseInt(transaction.amount) * parseFloat(exchangeRate.sell),
    };
...
export default NegociateCurrencyPage;
